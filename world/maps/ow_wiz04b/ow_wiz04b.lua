-- ow_wiz04b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5014, y = 5405, dest = "ow_wiz04a:@4566,1850", name = "wiz04a" },
    { x = 602, y = 3156, dest = "ow_wiz04c:@4355,5485", name = "wiz04c" },
}
