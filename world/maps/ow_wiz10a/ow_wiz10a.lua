-- ow_wiz10a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5483, y = 5500, dest = "ow_wiz09d:@911,1070", name = "the wastelands" },
    { x = 5573, y = 5500, dest = "ow_wiz10b:@3089,5230", name = "the Land of the Dead (II)" },
}
