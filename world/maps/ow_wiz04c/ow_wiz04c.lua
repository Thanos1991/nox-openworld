-- ow_wiz04c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4355, y = 5485, dest = "ow_wiz04b:@5014,5405", name = "wiz04b" },
    { x = 667, y = 656, dest = "ow_wiz05a:@1523,3480", name = "wiz05a" },
}
