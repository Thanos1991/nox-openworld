-- ow_con09c gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 236, y = 4885, dest = "ow_con09b:@3841,483", name = "con09b" },
    { x = 318, y = 4960, dest = "ow_con09d:@2213,5317", name = "con09d" },
}
