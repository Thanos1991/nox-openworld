-- ow_wiz06b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4213, y = 4373, dest = "ow_wiz06a:@3897,3713", name = "wiz06a" },
    { x = 3614, y = 3012, dest = "ow_wiz06c:@3185,3128", name = "wiz06c" },
}
