...
local GATES = {
    { x = 3319, y = 4757, dest = "ow_wiz02a:@3668,3006", name = "Galava" },
    { x = 1136, y = 3225, dest = "ow_wiz02c:@771,5417", name = "the Lost Library, second floor" },
    { x = 3250, y = 694, dest = "ow_wiz02c:@1301,329", name = "the Lost Library, second floor" },
