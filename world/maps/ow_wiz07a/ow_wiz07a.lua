-- ow_wiz07a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2621, y = 4056, dest = "ow_wiz06c:@3185,3128", name = "wiz06c" },
    { x = 2870, y = 3827, dest = "ow_wiz07f:@1410,5282", name = "wiz07f" },
}
