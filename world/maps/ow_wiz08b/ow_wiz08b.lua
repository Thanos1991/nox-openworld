-- ow_wiz08b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3864, y = 4669, dest = "ow_wiz08a:@4043,1533", name = "wiz08a" },
    { x = 5486, y = 380, dest = "ow_wiz08c:@1954,4234", name = "wiz08c" },
}
