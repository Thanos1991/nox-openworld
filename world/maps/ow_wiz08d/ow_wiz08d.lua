-- ow_wiz08d gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4358, y = 5108, dest = "ow_wiz08c:@1954,4234", name = "wiz08c" },
    { x = 5522, y = 4783, dest = "ow_wiz08e:@1097,3264", name = "wiz08e" },
}
