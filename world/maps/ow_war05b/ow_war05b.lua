...
local GATES = {
    { x = 241, y = 1530, dest = "ow_war05a:@3101,149", name = "war05a" },
    { x = 1365, y = 5552, dest = "ow_war05c:@4692,644", name = "war05c" },
    { x = 1923, y = 297, dest = "ow_war05c:@4692,644", name = "war05c" },
    { x = 1298, y = 4556, dest = "ow_war06a:@5277,2516", name = "war06a" },
}
