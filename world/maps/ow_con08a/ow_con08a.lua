...
local GATES = {
    { x = 5440, y = 3876, dest = "ow_con03a:@481,414", name = "con03a" },
    { x = 1018, y = 3627, dest = "ow_con07h:@2149,2150", name = "con07h" },
    { x = 3979, y = 1472, dest = "ow_con08b:@3875,4657", name = "con08b" },
    { x = 1108, y = 3627, dest = "ow_con08e:@4330,3439", name = "con08e" },
