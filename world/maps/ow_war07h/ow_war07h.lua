-- ow_war07h gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2621, y = 4056, dest = "ow_war06b:@3187,3126", name = "war06b" },
    { x = 2870, y = 3827, dest = "ow_war07a:@1414,5278", name = "war07a" },
}
