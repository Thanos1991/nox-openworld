-- ow_war10b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3153, y = 5284, dest = "ow_war10a:@5486,5499", name = "war10a" },
    { x = 3094, y = 5228, dest = "ow_war10c:@1127,2818", name = "war10c" },
}
