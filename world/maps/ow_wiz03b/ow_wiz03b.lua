-- ow_wiz03b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5438, y = 3506, dest = "ow_wiz03a:@585,4048", name = "wiz03a" },
    { x = 4652, y = 1492, dest = "ow_wiz03c:@1582,4572", name = "wiz03c" },
}
