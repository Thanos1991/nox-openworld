-- ow_con09b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1502, y = 3486, dest = "ow_con09a:@3496,1509", name = "con09a" },
    { x = 3925, y = 567, dest = "ow_con09c:@324,4965", name = "con09c" },
}
