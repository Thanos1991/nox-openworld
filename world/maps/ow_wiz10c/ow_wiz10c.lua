-- ow_wiz10c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1044, y = 2889, dest = "ow_wiz10b:@3089,5230", name = "the Land of the Dead (II)" },
    { x = 1103, y = 2830, dest = "ow_wiz10d:@2181,5287", name = "the Land of the Dead (IV)" },
}
