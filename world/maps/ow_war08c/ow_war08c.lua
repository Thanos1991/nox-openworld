-- ow_war08c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1867, y = 4318, dest = "ow_war08b:@5485,379", name = "war08b" },
    { x = 5692, y = 310, dest = "ow_war08d:@4358,5108", name = "war08d" },
}
