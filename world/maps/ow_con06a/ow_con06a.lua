-- ow_con06a gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 5187, y = 2516, dest = "ow_con05a:@1522,3481", name = "con05a" },
    { x = 3614, y = 3010, dest = "ow_con06b:@3235,3086", name = "con06b" },
}
