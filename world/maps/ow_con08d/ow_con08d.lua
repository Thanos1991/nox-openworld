-- ow_con08d gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 4359, y = 5107, dest = "ow_con08c:@1954,4234", name = "con08c" },
    { x = 5522, y = 4783, dest = "ow_con08e:@1152,3183", name = "con08e" },
}
