-- ow_wiz09b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1502, y = 3486, dest = "ow_wiz09a:@3496,1509", name = "the swamp (west)" },
    { x = 3925, y = 567, dest = "ow_wiz09c:@324,4965", name = "the tunnels" },
}
