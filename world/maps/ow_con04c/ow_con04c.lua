-- ow_con04c gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 4350, y = 5486, dest = "ow_con04b:@5002,5394", name = "con04b" },
    { x = 667, y = 656, dest = "ow_con05a:@1522,3481", name = "con05a" },
}
