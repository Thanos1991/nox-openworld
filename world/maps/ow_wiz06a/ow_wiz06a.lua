-- ow_wiz06a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4036, y = 4576, dest = "ow_wiz05a:@3613,1167", name = "wiz05a" },
    { x = 3886, y = 3491, dest = "ow_wiz06b:@4164,4322", name = "wiz06b" },
}
