-- ow_war05a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1522, y = 3481, dest = "ow_war04c:@4369,5492", name = "war04c" },
    { x = 3101, y = 149, dest = "ow_war05b:@381,1423", name = "war05b" },
}
