-- ow_con07h gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2333, y = 1701, dest = "ow_con07g:@3468,3909", name = "con07g" },
    { x = 2149, y = 2150, dest = "ow_con08a:@1018,3627", name = "con08a" },
}
