-- ow_war07b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 836, y = 4751, dest = "ow_war07a:@3621,3059", name = "war07a" },
    { x = 2642, y = 4287, dest = "ow_war07c:@3252,2082", name = "war07c" },
}
