-- ow_wiz08c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1867, y = 4318, dest = "ow_wiz08b:@5485,379", name = "wiz08b" },
    { x = 5692, y = 310, dest = "ow_wiz08d:@4358,5108", name = "wiz08d" },
}
