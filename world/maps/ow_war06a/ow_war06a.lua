...
local GATES = {
    { x = 5187, y = 2516, dest = "ow_con05b:@1298,4556", name = "con05b" },
    { x = 5277, y = 2516, dest = "ow_war05b:@1298,4556", name = "war05b" },
    { x = 3614, y = 3010, dest = "ow_war06b:@3113,3205", name = "war06b" },
}
