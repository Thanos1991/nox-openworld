-- ow_wiz09a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5505, y = 5613, dest = "ow_wiz08a:@426,2128", name = "wiz08a" },
    { x = 3601, y = 1433, dest = "ow_wiz09b:@1589,3400", name = "the swamp (east)" },
}
