-- ow_war09a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5505, y = 5613, dest = "ow_war08a:@1991,5023", name = "war08a" },
    { x = 3601, y = 1433, dest = "ow_war09b:@1588,3400", name = "war09b" },
}
