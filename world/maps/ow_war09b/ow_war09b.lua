-- ow_war09b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1502, y = 3486, dest = "ow_war09a:@3496,1509", name = "war09a" },
    { x = 3925, y = 567, dest = "ow_war09c:@324,4965", name = "war09c" },
}
