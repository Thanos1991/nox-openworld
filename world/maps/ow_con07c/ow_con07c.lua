-- ow_con07c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 832, y = 4753, dest = "ow_con07b:@3599,3082", name = "con07b" },
    { x = 2639, y = 4284, dest = "ow_con07d:@3264,2093", name = "con07d" },
}
