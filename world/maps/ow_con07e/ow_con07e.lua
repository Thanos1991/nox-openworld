-- ow_con07e gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3479, y = 2011, dest = "ow_con07d:@2226,654", name = "con07d" },
    { x = 4808, y = 3034, dest = "ow_con07f:@4417,4962", name = "con07f" },
}
