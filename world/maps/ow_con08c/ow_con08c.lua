-- ow_con08c gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 1867, y = 4318, dest = "ow_con08b:@5486,380", name = "con08b" },
    { x = 5692, y = 310, dest = "ow_con08d:@4359,5107", name = "con08d" },
}
