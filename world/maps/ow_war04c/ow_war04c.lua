-- ow_war04c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4369, y = 5492, dest = "ow_war04b:@5002,5394", name = "war04b" },
    { x = 667, y = 656, dest = "ow_war05a:@1522,3481", name = "war05a" },
}
