-- ow_war10c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1043, y = 2890, dest = "ow_war10b:@3094,5228", name = "war10b" },
    { x = 1127, y = 2818, dest = "ow_war10d:@2183,5284", name = "war10d" },
}
