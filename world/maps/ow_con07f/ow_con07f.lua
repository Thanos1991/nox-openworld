-- ow_con07f gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4363, y = 5017, dest = "ow_con07e:@4725,3101", name = "con07e" },
    { x = 3648, y = 3888, dest = "ow_con07g:@2452,3098", name = "con07g" },
}
