-- ow_wiz07c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4497, y = 4152, dest = "ow_wiz07b:@2131,4931", name = "wiz07b" },
    { x = 2266, y = 3370, dest = "ow_wiz08a:@788,4473", name = "wiz08a" },
}
