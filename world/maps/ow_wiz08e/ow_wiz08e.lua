-- ow_wiz08e gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4330, y = 3439, dest = "ow_wiz08a:@2656,1488", name = "wiz08a" },
    { x = 1035, y = 3335, dest = "ow_wiz08d:@5345,4953", name = "wiz08d" },
}
