-- ow_con09d gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2128, y = 5438, dest = "ow_con09c:@3841,2095", name = "con09c" },
    { x = 903, y = 1062, dest = "ow_con10a:@5488,5511", name = "con10a" },
}
