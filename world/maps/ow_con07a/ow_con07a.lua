-- ow_con07a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2621, y = 4056, dest = "ow_con06b:@3190,3125", name = "con06b" },
    { x = 2870, y = 3827, dest = "ow_con07b:@1410,5282", name = "con07b" },
}
