-- ow_war04a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4564, y = 1850, dest = "ow_war03b:@5159,3741", name = "war03b" },
    { x = 1184, y = 954, dest = "ow_war04b:@5002,5394", name = "war04b" },
}
