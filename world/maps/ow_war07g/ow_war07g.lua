-- ow_war07g gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2405, y = 1758, dest = "ow_war07f:@3444,3884", name = "war07f" },
    { x = 1920, y = 2013, dest = "ow_war08a:@997,3621", name = "war08a" },
}
