-- ow_con10a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5578, y = 5511, dest = "ow_con09d:@911,1073", name = "con09d" },
    { x = 5488, y = 5511, dest = "ow_con10b:@3084,5227", name = "con10b" },
}
