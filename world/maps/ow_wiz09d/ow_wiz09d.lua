-- ow_wiz09d gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2129, y = 5439, dest = "ow_wiz09c:@3816,2151", name = "the tunnels" },
    { x = 903, y = 1062, dest = "ow_wiz10a:@5483,5500", name = "the Land of the Dead (I)" },
}
