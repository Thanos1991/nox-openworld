-- ow_war03a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5704, y = 4232, dest = "ow_war01a:@5084,2710", name = "war01a" },
    { x = 344, y = 386, dest = "ow_war03b:@2392,3657", name = "war03b" },
}
