-- ow_con07d gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 3334, y = 2150, dest = "ow_con07c:@2633,4400", name = "con07c" },
    { x = 2287, y = 586, dest = "ow_con07e:@3786,1943", name = "con07e" },
}
