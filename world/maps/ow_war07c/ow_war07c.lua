-- ow_war07c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3331, y = 2150, dest = "ow_war07b:@2625,4389", name = "war07b" },
    { x = 2311, y = 610, dest = "ow_war07d:@3568,1998", name = "war07d" },
}
