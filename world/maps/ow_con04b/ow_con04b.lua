-- ow_con04b gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 5002, y = 5394, dest = "ow_con04a:@4576,1861", name = "con04a" },
    { x = 602, y = 3156, dest = "ow_con04c:@4350,5486", name = "con04c" },
}
