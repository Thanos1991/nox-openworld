-- ow_wiz10b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3151, y = 5278, dest = "ow_wiz10a:@5483,5500", name = "the Land of the Dead (I)" },
    { x = 3089, y = 5230, dest = "ow_wiz10c:@1103,2830", name = "the Land of the Dead (III)" },
}
