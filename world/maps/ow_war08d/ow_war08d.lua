-- ow_war08d gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4358, y = 5108, dest = "ow_war08c:@1944,4244", name = "war08c" },
    { x = 5522, y = 4783, dest = "ow_war08e:@1097,3264", name = "war08e" },
}
