-- ow_war06b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3113, y = 3205, dest = "ow_war06a:@3436,3205", name = "war06a" },
    { x = 5392, y = 2955, dest = "ow_war07h:@2621,4056", name = "war07h" },
}
