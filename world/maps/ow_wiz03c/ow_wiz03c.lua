-- ow_wiz03c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1035, y = 4899, dest = "ow_wiz03b:@4654,1492", name = "wiz03b" },
    { x = 1462, y = 4678, dest = "ow_wiz03b:@5192,5131", name = "wiz03b" },
}
