-- ow_wiz07b gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2131, y = 4931, dest = "ow_wiz07c:@4496,4152", name = "wiz07c" },
    { x = 457, y = 892, dest = "ow_wiz07e:@2797,1868", name = "wiz07e" },
}
