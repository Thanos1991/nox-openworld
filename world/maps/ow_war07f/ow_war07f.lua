-- ow_war07f gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 2514, y = 3169, dest = "ow_war07e:@3735,3981", name = "war07e" },
    { x = 3396, y = 3803, dest = "ow_war07g:@2340,1697", name = "war07g" },
}
