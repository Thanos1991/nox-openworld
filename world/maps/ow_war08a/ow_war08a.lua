...
local GATES = {
    { x = 5440, y = 3876, dest = "ow_con03a:@571,414", name = "con03a" },
    { x = 1087, y = 3621, dest = "ow_war07g:@1920,2013", name = "war07g" },
    { x = 3972, y = 1479, dest = "ow_war08b:@3864,4669", name = "war08b" },
    { x = 997, y = 3621, dest = "ow_war08e:@4330,3439", name = "war08e" },
