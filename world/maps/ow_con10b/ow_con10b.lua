-- ow_con10b gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 3151, y = 5290, dest = "ow_con10a:@5578,5511", name = "con10a" },
    { x = 3084, y = 5227, dest = "ow_con10c:@1045,2891", name = "con10c" },
}
