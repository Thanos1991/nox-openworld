-- ow_war10a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5576, y = 5499, dest = "ow_war09d:@911,1070", name = "war09d" },
    { x = 5486, y = 5499, dest = "ow_war10b:@3094,5228", name = "war10b" },
}
