-- ow_war07e gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4477, y = 4897, dest = "ow_war07d:@4726,3101", name = "war07d" },
    { x = 3648, y = 3889, dest = "ow_war07f:@2445,3110", name = "war07f" },
}
