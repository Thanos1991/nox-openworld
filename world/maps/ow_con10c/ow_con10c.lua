-- ow_con10c gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 1045, y = 2891, dest = "ow_con10b:@3049,5169", name = "con10b" },
    { x = 1119, y = 2816, dest = "ow_con10d:@2185,5297", name = "con10d" },
}
