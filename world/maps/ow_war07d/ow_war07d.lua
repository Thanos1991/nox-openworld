-- ow_war07d gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3499, y = 2033, dest = "ow_war07c:@2255,682", name = "war07c" },
    { x = 4802, y = 3037, dest = "ow_war07e:@4539,4837", name = "war07e" },
}
