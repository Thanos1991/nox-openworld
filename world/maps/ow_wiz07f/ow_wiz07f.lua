-- ow_wiz07f gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1367, y = 5330, dest = "ow_wiz07a:@2822,3908", name = "wiz07a" },
    { x = 3668, y = 3006, dest = "ow_wiz07d:@3389,4699", name = "wiz07d" },
}
