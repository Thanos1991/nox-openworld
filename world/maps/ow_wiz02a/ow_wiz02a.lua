-- ow_wiz02a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 1364, y = 5327, dest = "ow_wiz01a:@1246,1413", name = "the forest" },
    { x = 3668, y = 3006, dest = "ow_wiz02b:@3389,4699", name = "the Lost Library, first floor" },
}
