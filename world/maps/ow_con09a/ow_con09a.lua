-- ow_con09a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 5505, y = 5613, dest = "ow_con08a:@632,1920", name = "con08a" },
    { x = 3601, y = 1433, dest = "ow_con09b:@1591,3400", name = "con09b" },
}
