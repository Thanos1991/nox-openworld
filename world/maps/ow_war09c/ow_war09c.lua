-- ow_war09c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 236, y = 4885, dest = "ow_war09b:@3841,483", name = "war09b" },
    { x = 334, y = 4891, dest = "ow_war09d:@2213,5324", name = "war09d" },
}
