-- ow_con04a gates — GENERATED by tools/owworld, do not edit by hand.
-- Regenerate: go run ./tools/owgates <maps>; go run ./tools/owworld

local Nox = require("Nox.Map.Script.v0")

local GATES = {
    { x = 4576, y = 1861, dest = "ow_con03a:@651,3421", name = "con03a" },
    { x = 1184, y = 943, dest = "ow_con04b:@5002,5394", name = "con04b" },
}
