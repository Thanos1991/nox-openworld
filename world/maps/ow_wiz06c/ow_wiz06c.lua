-- ow_wiz06c gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 3095, y = 3208, dest = "ow_wiz06b:@3438,3232", name = "wiz06b" },
    { x = 657, y = 2726, dest = "ow_wiz07a:@2621,4056", name = "wiz07a" },
}
