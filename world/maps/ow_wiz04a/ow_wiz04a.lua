-- ow_wiz04a gates — GENERATED by tools/owworld, do not edit by hand.
...
local GATES = {
    { x = 4566, y = 1850, dest = "ow_wiz03a:@3461,5278", name = "wiz03a" },
    { x = 1184, y = 943, dest = "ow_wiz04b:@5014,5405", name = "wiz04b" },
}
